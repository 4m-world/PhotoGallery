...
namespace PhotoGallery.Infrastructure
{
    public class PhotoGalleryContext : DbContext
    {
        ...
        {
            // Photos
            modelBuilder.Entity<Photo>().Property(p => p.Title).HasMaxLength(128);
            modelBuilder.Entity<Photo>().Property(p => p.AlbumId).IsRequired();

            // Album
            modelBuilder.Entity<Album>().Property(a => a.Title).HasMaxLength(128);
            modelBuilder.Entity<Album>().Property(a => a.Description).HasMaxLength(512);
            ...
            modelBuilder.Entity<User>().Property(u => u.HashedPassword).IsRequired().HasMaxLength(256);
            modelBuilder.Entity<User>().Property(u => u.Salt).IsRequired().HasMaxLength(256);
